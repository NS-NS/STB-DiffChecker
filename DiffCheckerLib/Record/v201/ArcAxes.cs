        ...
        internal static List<Record> Check(ST_BRIDGE stBridgeA, ST_BRIDGE stBridgeB)
        {
            ...
            if (axesA != null)
            {
                foreach (var a in axesA)
                {
                    ...
                    {
                        CheckObjects.StbArcAxes.AppendConcistentRecord(nameof(StbArcAxes), key, records);
                        ...
                        foreach (var axisA in a.StbArcAxis)
                        {
                            ...
                            foreach (var axisB in b.StbArcAxis)
                            {
                                ...
                                {
                                    CheckObjects.StbArcAxis.AppendConcistentRecord(nameof(StbArcAxis), key2, records);

...
namespace STB_DiffChecker_210
{
    ...
    public partial class MainWindow : AbstractMainWindow
    {
        ...
        {
            return XmlValidate.LoadSTBridgeFile(path, encoding, schemaContent, new ST_BRIDGE210.ST_BRIDGE(), out errors);
        }
        ...
        private void RunCompare()
        {
            ...
            //比較
            ST_BRIDGE210.ST_BRIDGE stbA = istBridgeA as ST_BRIDGE210.ST_BRIDGE;
            ST_BRIDGE210.ST_BRIDGE stbB = istBridgeB as ST_BRIDGE210.ST_BRIDGE;
